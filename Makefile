...
parser.js: $(GRAMMAR)
    ...
    # Security patch to jison
	patch -b node_modules/jison-lex/regexp-lexer.js <jison-lex.diff

	$(JISON) $^ -o $(OUTPUT)/parser.js -m js

    # Undo patch to jison
	mv node_modules/jison-lex/regexp-lexer.js.orig node_modules/jison-lex/regexp-lexer.js
