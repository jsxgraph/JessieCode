...
var act_tab = new Array(
	...
	/* State 7 */ new Array( 26/* "(" */,29 , 14/* "=" */,30 , 13/* ";" */,-36 , 15/* "==" */,-36 , 20/* "<" */,-36 , 19/* ">" */,-36 , 17/* "<=" */,-36 , 18/* ">=" */,-36 , 16/* "!=" */,-36 , 22/* "-" */,-36 , 21/* "+" */,-36 , 24/* "*" */,-36 , 23/* "/" */,-36 ),
	/* State 8 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 13/* ";" */,37 ),
	...
	/* State 11 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-25 , 15/* "==" */,-25 , 20/* "<" */,-25 , 19/* ">" */,-25 , 17/* "<=" */,-25 , 18/* ">=" */,-25 , 16/* "!=" */,-25 , 2/* "IF" */,-25 , 4/* "WHILE" */,-25 , 5/* "DO" */,-25 , 8/* "USE" */,-25 , 29/* "Identifier" */,-25 , 11/* "{" */,-25 , 31/* "Integer" */,-25 , 32/* "Float" */,-25 , 26/* "(" */,-25 , 30/* "String" */,-25 , 6/* "CREATE" */,-25 , 7/* "FUNCTION" */,-25 , 9/* "X" */,-25 , 10/* "Y" */,-25 , 27/* ")" */,-25 , 25/* "," */,-25 ),
	/* State 12 */ new Array( 23/* "/" */,41 , 24/* "*" */,42 , 13/* ";" */,-28 , 15/* "==" */,-28 , 20/* "<" */,-28 , 19/* ">" */,-28 , 17/* "<=" */,-28 , 18/* ">=" */,-28 , 16/* "!=" */,-28 , 22/* "-" */,-28 , 21/* "+" */,-28 , 2/* "IF" */,-28 , 4/* "WHILE" */,-28 , 5/* "DO" */,-28 , 8/* "USE" */,-28 , 29/* "Identifier" */,-28 , 11/* "{" */,-28 , 31/* "Integer" */,-28 , 32/* "Float" */,-28 , 26/* "(" */,-28 , 30/* "String" */,-28 , 6/* "CREATE" */,-28 , 7/* "FUNCTION" */,-28 , 9/* "X" */,-28 , 10/* "Y" */,-28 , 27/* ")" */,-28 , 25/* "," */,-28 ),
	...
	/* State 20 */ new Array( 26/* "(" */,45 ),
	/* State 21 */ new Array( 26/* "(" */,46 ),
	/* State 22 */ new Array( 26/* "(" */,47 ),
	/* State 23 */ new Array( 26/* "(" */,48 ),
	/* State 24 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 2/* "IF" */,3 , 4/* "WHILE" */,4 , 5/* "DO" */,5 , 8/* "USE" */,6 , 29/* "Identifier" */,7 , 11/* "{" */,9 , 13/* ";" */,10 , 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 25 */ new Array( 26/* "(" */,29 , 2/* "IF" */,-36 , 4/* "WHILE" */,-36 , 5/* "DO" */,-36 , 8/* "USE" */,-36 , 29/* "Identifier" */,-36 , 11/* "{" */,-36 , 13/* ";" */,-36 , 22/* "-" */,-36 , 31/* "Integer" */,-36 , 32/* "Float" */,-36 , 30/* "String" */,-36 , 6/* "CREATE" */,-36 , 7/* "FUNCTION" */,-36 , 9/* "X" */,-36 , 10/* "Y" */,-36 , 15/* "==" */,-36 , 20/* "<" */,-36 , 19/* ">" */,-36 , 17/* "<=" */,-36 , 18/* ">=" */,-36 , 16/* "!=" */,-36 , 21/* "+" */,-36 , 24/* "*" */,-36 , 23/* "/" */,-36 , 27/* ")" */,-36 , 25/* "," */,-36 ),
	/* State 26 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 2/* "IF" */,3 , 4/* "WHILE" */,4 , 5/* "DO" */,5 , 8/* "USE" */,6 , 29/* "Identifier" */,7 , 11/* "{" */,9 , 13/* ";" */,10 , 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	...
	/* State 36 */ new Array( 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 29/* "Identifier" */,25 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 37 */ new Array( 43/* "$" */,-16 , 2/* "IF" */,-16 , 4/* "WHILE" */,-16 , 5/* "DO" */,-16 , 8/* "USE" */,-16 , 29/* "Identifier" */,-16 , 11/* "{" */,-16 , 13/* ";" */,-16 , 22/* "-" */,-16 , 31/* "Integer" */,-16 , 32/* "Float" */,-16 , 26/* "(" */,-16 , 30/* "String" */,-16 , 6/* "CREATE" */,-16 , 7/* "FUNCTION" */,-16 , 9/* "X" */,-16 , 10/* "Y" */,-16 , 3/* "ELSE" */,-16 , 12/* "}" */,-16 ),
	/* State 38 */ new Array( 12/* "}" */,63 , 2/* "IF" */,3 , 4/* "WHILE" */,4 , 5/* "DO" */,5 , 8/* "USE" */,6 , 29/* "Identifier" */,7 , 11/* "{" */,9 , 13/* ";" */,10 , 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	...
	/* State 42 */ new Array( 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 29/* "Identifier" */,25 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 43 */ new Array( 13/* ";" */,-32 , 15/* "==" */,-32 , 20/* "<" */,-32 , 19/* ">" */,-32 , 17/* "<=" */,-32 , 18/* ">=" */,-32 , 16/* "!=" */,-32 , 22/* "-" */,-32 , 21/* "+" */,-32 , 24/* "*" */,-32 , 23/* "/" */,-32 , 2/* "IF" */,-32 , 4/* "WHILE" */,-32 , 5/* "DO" */,-32 , 8/* "USE" */,-32 , 29/* "Identifier" */,-32 , 11/* "{" */,-32 , 31/* "Integer" */,-32 , 32/* "Float" */,-32 , 26/* "(" */,-32 , 30/* "String" */,-32 , 6/* "CREATE" */,-32 , 7/* "FUNCTION" */,-32 , 9/* "X" */,-32 , 10/* "Y" */,-32 , 27/* ")" */,-32 , 25/* "," */,-32 ),
	/* State 44 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 27/* ")" */,68 ),
	/* State 45 */ new Array( 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 29/* "Identifier" */,25 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 46 */ new Array( 29/* "Identifier" */,71 , 27/* ")" */,-9 , 25/* "," */,-9 ),
	/* State 47 */ new Array( 29/* "Identifier" */,72 ),
	/* State 48 */ new Array( 29/* "Identifier" */,73 ),
	/* State 49 */ new Array( 3/* "ELSE" */,74 , 43/* "$" */,-10 , 2/* "IF" */,-10 , 4/* "WHILE" */,-10 , 5/* "DO" */,-10 , 8/* "USE" */,-10 , 29/* "Identifier" */,-10 , 11/* "{" */,-10 , 13/* ";" */,-10 , 22/* "-" */,-10 , 31/* "Integer" */,-10 , 32/* "Float" */,-10 , 26/* "(" */,-10 , 30/* "String" */,-10 , 6/* "CREATE" */,-10 , 7/* "FUNCTION" */,-10 , 9/* "X" */,-10 , 10/* "Y" */,-10 , 12/* "}" */,-10 ),
	/* State 50 */ new Array( 43/* "$" */,-12 , 2/* "IF" */,-12 , 4/* "WHILE" */,-12 , 5/* "DO" */,-12 , 8/* "USE" */,-12 , 29/* "Identifier" */,-12 , 11/* "{" */,-12 , 13/* ";" */,-12 , 22/* "-" */,-12 , 31/* "Integer" */,-12 , 32/* "Float" */,-12 , 26/* "(" */,-12 , 30/* "String" */,-12 , 6/* "CREATE" */,-12 , 7/* "FUNCTION" */,-12 , 9/* "X" */,-12 , 10/* "Y" */,-12 , 3/* "ELSE" */,-12 , 12/* "}" */,-12 ),
	/* State 51 */ new Array( 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 29/* "Identifier" */,25 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 52 */ new Array( 43/* "$" */,-14 , 2/* "IF" */,-14 , 4/* "WHILE" */,-14 , 5/* "DO" */,-14 , 8/* "USE" */,-14 , 29/* "Identifier" */,-14 , 11/* "{" */,-14 , 13/* ";" */,-14 , 22/* "-" */,-14 , 31/* "Integer" */,-14 , 32/* "Float" */,-14 , 26/* "(" */,-14 , 30/* "String" */,-14 , 6/* "CREATE" */,-14 , 7/* "FUNCTION" */,-14 , 9/* "X" */,-14 , 10/* "Y" */,-14 , 3/* "ELSE" */,-14 , 12/* "}" */,-14 ),
	/* State 53 */ new Array( 25/* "," */,76 , 27/* ")" */,77 ),
	/* State 54 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 27/* ")" */,-6 , 25/* "," */,-6 ),
	/* State 55 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 13/* ";" */,78 ),
	/* State 56 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-24 , 15/* "==" */,-24 , 20/* "<" */,-24 , 19/* ">" */,-24 , 17/* "<=" */,-24 , 18/* ">=" */,-24 , 16/* "!=" */,-24 , 2/* "IF" */,-24 , 4/* "WHILE" */,-24 , 5/* "DO" */,-24 , 8/* "USE" */,-24 , 29/* "Identifier" */,-24 , 11/* "{" */,-24 , 31/* "Integer" */,-24 , 32/* "Float" */,-24 , 26/* "(" */,-24 , 30/* "String" */,-24 , 6/* "CREATE" */,-24 , 7/* "FUNCTION" */,-24 , 9/* "X" */,-24 , 10/* "Y" */,-24 , 27/* ")" */,-24 , 25/* "," */,-24 ),
	/* State 57 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-23 , 15/* "==" */,-23 , 20/* "<" */,-23 , 19/* ">" */,-23 , 17/* "<=" */,-23 , 18/* ">=" */,-23 , 16/* "!=" */,-23 , 2/* "IF" */,-23 , 4/* "WHILE" */,-23 , 5/* "DO" */,-23 , 8/* "USE" */,-23 , 29/* "Identifier" */,-23 , 11/* "{" */,-23 , 31/* "Integer" */,-23 , 32/* "Float" */,-23 , 26/* "(" */,-23 , 30/* "String" */,-23 , 6/* "CREATE" */,-23 , 7/* "FUNCTION" */,-23 , 9/* "X" */,-23 , 10/* "Y" */,-23 , 27/* ")" */,-23 , 25/* "," */,-23 ),
	/* State 58 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-22 , 15/* "==" */,-22 , 20/* "<" */,-22 , 19/* ">" */,-22 , 17/* "<=" */,-22 , 18/* ">=" */,-22 , 16/* "!=" */,-22 , 2/* "IF" */,-22 , 4/* "WHILE" */,-22 , 5/* "DO" */,-22 , 8/* "USE" */,-22 , 29/* "Identifier" */,-22 , 11/* "{" */,-22 , 31/* "Integer" */,-22 , 32/* "Float" */,-22 , 26/* "(" */,-22 , 30/* "String" */,-22 , 6/* "CREATE" */,-22 , 7/* "FUNCTION" */,-22 , 9/* "X" */,-22 , 10/* "Y" */,-22 , 27/* ")" */,-22 , 25/* "," */,-22 ),
	/* State 59 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-21 , 15/* "==" */,-21 , 20/* "<" */,-21 , 19/* ">" */,-21 , 17/* "<=" */,-21 , 18/* ">=" */,-21 , 16/* "!=" */,-21 , 2/* "IF" */,-21 , 4/* "WHILE" */,-21 , 5/* "DO" */,-21 , 8/* "USE" */,-21 , 29/* "Identifier" */,-21 , 11/* "{" */,-21 , 31/* "Integer" */,-21 , 32/* "Float" */,-21 , 26/* "(" */,-21 , 30/* "String" */,-21 , 6/* "CREATE" */,-21 , 7/* "FUNCTION" */,-21 , 9/* "X" */,-21 , 10/* "Y" */,-21 , 27/* ")" */,-21 , 25/* "," */,-21 ),
	/* State 60 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-20 , 15/* "==" */,-20 , 20/* "<" */,-20 , 19/* ">" */,-20 , 17/* "<=" */,-20 , 18/* ">=" */,-20 , 16/* "!=" */,-20 , 2/* "IF" */,-20 , 4/* "WHILE" */,-20 , 5/* "DO" */,-20 , 8/* "USE" */,-20 , 29/* "Identifier" */,-20 , 11/* "{" */,-20 , 31/* "Integer" */,-20 , 32/* "Float" */,-20 , 26/* "(" */,-20 , 30/* "String" */,-20 , 6/* "CREATE" */,-20 , 7/* "FUNCTION" */,-20 , 9/* "X" */,-20 , 10/* "Y" */,-20 , 27/* ")" */,-20 , 25/* "," */,-20 ),
	/* State 61 */ new Array( 21/* "+" */,39 , 22/* "-" */,40 , 13/* ";" */,-19 , 15/* "==" */,-19 , 20/* "<" */,-19 , 19/* ">" */,-19 , 17/* "<=" */,-19 , 18/* ">=" */,-19 , 16/* "!=" */,-19 , 2/* "IF" */,-19 , 4/* "WHILE" */,-19 , 5/* "DO" */,-19 , 8/* "USE" */,-19 , 29/* "Identifier" */,-19 , 11/* "{" */,-19 , 31/* "Integer" */,-19 , 32/* "Float" */,-19 , 26/* "(" */,-19 , 30/* "String" */,-19 , 6/* "CREATE" */,-19 , 7/* "FUNCTION" */,-19 , 9/* "X" */,-19 , 10/* "Y" */,-19 , 27/* ")" */,-19 , 25/* "," */,-19 ),
	/* State 62 */ new Array( 12/* "}" */,-3 , 2/* "IF" */,-3 , 4/* "WHILE" */,-3 , 5/* "DO" */,-3 , 8/* "USE" */,-3 , 29/* "Identifier" */,-3 , 11/* "{" */,-3 , 13/* ";" */,-3 , 22/* "-" */,-3 , 31/* "Integer" */,-3 , 32/* "Float" */,-3 , 26/* "(" */,-3 , 30/* "String" */,-3 , 6/* "CREATE" */,-3 , 7/* "FUNCTION" */,-3 , 9/* "X" */,-3 , 10/* "Y" */,-3 ),
	/* State 63 */ new Array( 43/* "$" */,-17 , 2/* "IF" */,-17 , 4/* "WHILE" */,-17 , 5/* "DO" */,-17 , 8/* "USE" */,-17 , 29/* "Identifier" */,-17 , 11/* "{" */,-17 , 13/* ";" */,-17 , 22/* "-" */,-17 , 31/* "Integer" */,-17 , 32/* "Float" */,-17 , 26/* "(" */,-17 , 30/* "String" */,-17 , 6/* "CREATE" */,-17 , 7/* "FUNCTION" */,-17 , 9/* "X" */,-17 , 10/* "Y" */,-17 , 3/* "ELSE" */,-17 , 12/* "}" */,-17 ),
	/* State 64 */ new Array( 23/* "/" */,41 , 24/* "*" */,42 , 13/* ";" */,-27 , 15/* "==" */,-27 , 20/* "<" */,-27 , 19/* ">" */,-27 , 17/* "<=" */,-27 , 18/* ">=" */,-27 , 16/* "!=" */,-27 , 22/* "-" */,-27 , 21/* "+" */,-27 , 2/* "IF" */,-27 , 4/* "WHILE" */,-27 , 5/* "DO" */,-27 , 8/* "USE" */,-27 , 29/* "Identifier" */,-27 , 11/* "{" */,-27 , 31/* "Integer" */,-27 , 32/* "Float" */,-27 , 26/* "(" */,-27 , 30/* "String" */,-27 , 6/* "CREATE" */,-27 , 7/* "FUNCTION" */,-27 , 9/* "X" */,-27 , 10/* "Y" */,-27 , 27/* ")" */,-27 , 25/* "," */,-27 ),
	/* State 65 */ new Array( 23/* "/" */,41 , 24/* "*" */,42 , 13/* ";" */,-26 , 15/* "==" */,-26 , 20/* "<" */,-26 , 19/* ">" */,-26 , 17/* "<=" */,-26 , 18/* ">=" */,-26 , 16/* "!=" */,-26 , 22/* "-" */,-26 , 21/* "+" */,-26 , 2/* "IF" */,-26 , 4/* "WHILE" */,-26 , 5/* "DO" */,-26 , 8/* "USE" */,-26 , 29/* "Identifier" */,-26 , 11/* "{" */,-26 , 31/* "Integer" */,-26 , 32/* "Float" */,-26 , 26/* "(" */,-26 , 30/* "String" */,-26 , 6/* "CREATE" */,-26 , 7/* "FUNCTION" */,-26 , 9/* "X" */,-26 , 10/* "Y" */,-26 , 27/* ")" */,-26 , 25/* "," */,-26 ),
	/* State 66 */ new Array( 13/* ";" */,-30 , 15/* "==" */,-30 , 20/* "<" */,-30 , 19/* ">" */,-30 , 17/* "<=" */,-30 , 18/* ">=" */,-30 , 16/* "!=" */,-30 , 22/* "-" */,-30 , 21/* "+" */,-30 , 24/* "*" */,-30 , 23/* "/" */,-30 , 2/* "IF" */,-30 , 4/* "WHILE" */,-30 , 5/* "DO" */,-30 , 8/* "USE" */,-30 , 29/* "Identifier" */,-30 , 11/* "{" */,-30 , 31/* "Integer" */,-30 , 32/* "Float" */,-30 , 26/* "(" */,-30 , 30/* "String" */,-30 , 6/* "CREATE" */,-30 , 7/* "FUNCTION" */,-30 , 9/* "X" */,-30 , 10/* "Y" */,-30 , 27/* ")" */,-30 , 25/* "," */,-30 ),
	/* State 67 */ new Array( 13/* ";" */,-29 , 15/* "==" */,-29 , 20/* "<" */,-29 , 19/* ">" */,-29 , 17/* "<=" */,-29 , 18/* ">=" */,-29 , 16/* "!=" */,-29 , 22/* "-" */,-29 , 21/* "+" */,-29 , 24/* "*" */,-29 , 23/* "/" */,-29 , 2/* "IF" */,-29 , 4/* "WHILE" */,-29 , 5/* "DO" */,-29 , 8/* "USE" */,-29 , 29/* "Identifier" */,-29 , 11/* "{" */,-29 , 31/* "Integer" */,-29 , 32/* "Float" */,-29 , 26/* "(" */,-29 , 30/* "String" */,-29 , 6/* "CREATE" */,-29 , 7/* "FUNCTION" */,-29 , 9/* "X" */,-29 , 10/* "Y" */,-29 , 27/* ")" */,-29 , 25/* "," */,-29 ),
	/* State 68 */ new Array( 13/* ";" */,-37 , 15/* "==" */,-37 , 20/* "<" */,-37 , 19/* ">" */,-37 , 17/* "<=" */,-37 , 18/* ">=" */,-37 , 16/* "!=" */,-37 , 22/* "-" */,-37 , 21/* "+" */,-37 , 24/* "*" */,-37 , 23/* "/" */,-37 , 2/* "IF" */,-37 , 4/* "WHILE" */,-37 , 5/* "DO" */,-37 , 8/* "USE" */,-37 , 29/* "Identifier" */,-37 , 11/* "{" */,-37 , 31/* "Integer" */,-37 , 32/* "Float" */,-37 , 26/* "(" */,-37 , 30/* "String" */,-37 , 6/* "CREATE" */,-37 , 7/* "FUNCTION" */,-37 , 9/* "X" */,-37 , 10/* "Y" */,-37 , 27/* ")" */,-37 , 25/* "," */,-37 ),
	/* State 69 */ new Array( 25/* "," */,76 , 27/* ")" */,79 ),
	/* State 70 */ new Array( 25/* "," */,80 , 27/* ")" */,81 ),
	/* State 71 */ new Array( 27/* ")" */,-8 , 25/* "," */,-8 ),
	/* State 72 */ new Array( 27/* ")" */,82 ),
	/* State 73 */ new Array( 27/* ")" */,83 ),
	/* State 74 */ new Array( 2/* "IF" */,3 , 4/* "WHILE" */,4 , 5/* "DO" */,5 , 8/* "USE" */,6 , 29/* "Identifier" */,7 , 11/* "{" */,9 , 13/* ";" */,10 , 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 75 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 13/* ";" */,85 ),
	/* State 76 */ new Array( 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 29/* "Identifier" */,25 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 77 */ new Array( 13/* ";" */,-40 , 15/* "==" */,-40 , 20/* "<" */,-40 , 19/* ">" */,-40 , 17/* "<=" */,-40 , 18/* ">=" */,-40 , 16/* "!=" */,-40 , 22/* "-" */,-40 , 21/* "+" */,-40 , 24/* "*" */,-40 , 23/* "/" */,-40 , 2/* "IF" */,-40 , 4/* "WHILE" */,-40 , 5/* "DO" */,-40 , 8/* "USE" */,-40 , 29/* "Identifier" */,-40 , 11/* "{" */,-40 , 31/* "Integer" */,-40 , 32/* "Float" */,-40 , 26/* "(" */,-40 , 30/* "String" */,-40 , 6/* "CREATE" */,-40 , 7/* "FUNCTION" */,-40 , 9/* "X" */,-40 , 10/* "Y" */,-40 , 27/* ")" */,-40 , 25/* "," */,-40 ),
	/* State 78 */ new Array( 43/* "$" */,-15 , 2/* "IF" */,-15 , 4/* "WHILE" */,-15 , 5/* "DO" */,-15 , 8/* "USE" */,-15 , 29/* "Identifier" */,-15 , 11/* "{" */,-15 , 13/* ";" */,-15 , 22/* "-" */,-15 , 31/* "Integer" */,-15 , 32/* "Float" */,-15 , 26/* "(" */,-15 , 30/* "String" */,-15 , 6/* "CREATE" */,-15 , 7/* "FUNCTION" */,-15 , 9/* "X" */,-15 , 10/* "Y" */,-15 , 3/* "ELSE" */,-15 , 12/* "}" */,-15 ),
	/* State 79 */ new Array( 13/* ";" */,-39 , 15/* "==" */,-39 , 20/* "<" */,-39 , 19/* ">" */,-39 , 17/* "<=" */,-39 , 18/* ">=" */,-39 , 16/* "!=" */,-39 , 22/* "-" */,-39 , 21/* "+" */,-39 , 24/* "*" */,-39 , 23/* "/" */,-39 , 2/* "IF" */,-39 , 4/* "WHILE" */,-39 , 5/* "DO" */,-39 , 8/* "USE" */,-39 , 29/* "Identifier" */,-39 , 11/* "{" */,-39 , 31/* "Integer" */,-39 , 32/* "Float" */,-39 , 26/* "(" */,-39 , 30/* "String" */,-39 , 6/* "CREATE" */,-39 , 7/* "FUNCTION" */,-39 , 9/* "X" */,-39 , 10/* "Y" */,-39 , 27/* ")" */,-39 , 25/* "," */,-39 ),
	/* State 80 */ new Array( 29/* "Identifier" */,87 ),
	/* State 81 */ new Array( 11/* "{" */,88 ),
	/* State 82 */ new Array( 13/* ";" */,-42 , 15/* "==" */,-42 , 20/* "<" */,-42 , 19/* ">" */,-42 , 17/* "<=" */,-42 , 18/* ">=" */,-42 , 16/* "!=" */,-42 , 22/* "-" */,-42 , 21/* "+" */,-42 , 24/* "*" */,-42 , 23/* "/" */,-42 , 2/* "IF" */,-42 , 4/* "WHILE" */,-42 , 5/* "DO" */,-42 , 8/* "USE" */,-42 , 29/* "Identifier" */,-42 , 11/* "{" */,-42 , 31/* "Integer" */,-42 , 32/* "Float" */,-42 , 26/* "(" */,-42 , 30/* "String" */,-42 , 6/* "CREATE" */,-42 , 7/* "FUNCTION" */,-42 , 9/* "X" */,-42 , 10/* "Y" */,-42 , 27/* ")" */,-42 , 25/* "," */,-42 ),
	/* State 83 */ new Array( 13/* ";" */,-43 , 15/* "==" */,-43 , 20/* "<" */,-43 , 19/* ">" */,-43 , 17/* "<=" */,-43 , 18/* ">=" */,-43 , 16/* "!=" */,-43 , 22/* "-" */,-43 , 21/* "+" */,-43 , 24/* "*" */,-43 , 23/* "/" */,-43 , 2/* "IF" */,-43 , 4/* "WHILE" */,-43 , 5/* "DO" */,-43 , 8/* "USE" */,-43 , 29/* "Identifier" */,-43 , 11/* "{" */,-43 , 31/* "Integer" */,-43 , 32/* "Float" */,-43 , 26/* "(" */,-43 , 30/* "String" */,-43 , 6/* "CREATE" */,-43 , 7/* "FUNCTION" */,-43 , 9/* "X" */,-43 , 10/* "Y" */,-43 , 27/* ")" */,-43 , 25/* "," */,-43 ),
	/* State 84 */ new Array( 43/* "$" */,-11 , 2/* "IF" */,-11 , 4/* "WHILE" */,-11 , 5/* "DO" */,-11 , 8/* "USE" */,-11 , 29/* "Identifier" */,-11 , 11/* "{" */,-11 , 13/* ";" */,-11 , 22/* "-" */,-11 , 31/* "Integer" */,-11 , 32/* "Float" */,-11 , 26/* "(" */,-11 , 30/* "String" */,-11 , 6/* "CREATE" */,-11 , 7/* "FUNCTION" */,-11 , 9/* "X" */,-11 , 10/* "Y" */,-11 , 3/* "ELSE" */,-11 , 12/* "}" */,-11 ),
	/* State 85 */ new Array( 43/* "$" */,-13 , 2/* "IF" */,-13 , 4/* "WHILE" */,-13 , 5/* "DO" */,-13 , 8/* "USE" */,-13 , 29/* "Identifier" */,-13 , 11/* "{" */,-13 , 13/* ";" */,-13 , 22/* "-" */,-13 , 31/* "Integer" */,-13 , 32/* "Float" */,-13 , 26/* "(" */,-13 , 30/* "String" */,-13 , 6/* "CREATE" */,-13 , 7/* "FUNCTION" */,-13 , 9/* "X" */,-13 , 10/* "Y" */,-13 , 3/* "ELSE" */,-13 , 12/* "}" */,-13 ),
	/* State 86 */ new Array( 16/* "!=" */,31 , 18/* ">=" */,32 , 17/* "<=" */,33 , 19/* ">" */,34 , 20/* "<" */,35 , 15/* "==" */,36 , 27/* ")" */,-5 , 25/* "," */,-5 ),
	/* State 87 */ new Array( 27/* ")" */,-7 , 25/* "," */,-7 ),
	/* State 88 */ new Array( 12/* "}" */,-4 , 2/* "IF" */,-4 , 4/* "WHILE" */,-4 , 5/* "DO" */,-4 , 8/* "USE" */,-4 , 29/* "Identifier" */,-4 , 11/* "{" */,-4 , 13/* ";" */,-4 , 22/* "-" */,-4 , 31/* "Integer" */,-4 , 32/* "Float" */,-4 , 26/* "(" */,-4 , 30/* "String" */,-4 , 6/* "CREATE" */,-4 , 7/* "FUNCTION" */,-4 , 9/* "X" */,-4 , 10/* "Y" */,-4 ),
	/* State 89 */ new Array( 12/* "}" */,90 , 2/* "IF" */,3 , 4/* "WHILE" */,4 , 5/* "DO" */,5 , 8/* "USE" */,6 , 29/* "Identifier" */,7 , 11/* "{" */,9 , 13/* ";" */,10 , 22/* "-" */,14 , 31/* "Integer" */,16 , 32/* "Float" */,17 , 26/* "(" */,18 , 30/* "String" */,19 , 6/* "CREATE" */,20 , 7/* "FUNCTION" */,21 , 9/* "X" */,22 , 10/* "Y" */,23 ),
	/* State 90 */ new Array( 13/* ";" */,-41 , 15/* "==" */,-41 , 20/* "<" */,-41 , 19/* ">" */,-41 , 17/* "<=" */,-41 , 18/* ">=" */,-41 , 16/* "!=" */,-41 , 22/* "-" */,-41 , 21/* "+" */,-41 , 24/* "*" */,-41 , 23/* "/" */,-41 , 2/* "IF" */,-41 , 4/* "WHILE" */,-41 , 5/* "DO" */,-41 , 8/* "USE" */,-41 , 29/* "Identifier" */,-41 , 11/* "{" */,-41 , 31/* "Integer" */,-41 , 32/* "Float" */,-41 , 26/* "(" */,-41 , 30/* "String" */,-41 , 6/* "CREATE" */,-41 , 7/* "FUNCTION" */,-41 , 9/* "X" */,-41 , 10/* "Y" */,-41 , 27/* ")" */,-41 , 25/* "," */,-41 )
);
...
var goto_tab = new Array(
	...
	/* State 7 */ new Array(  ),
	/* State 8 */ new Array(  ),
	/* State 9 */ new Array( 35/* Stmt_List */,38 ),
	/* State 10 */ new Array(  ),
	/* State 11 */ new Array(  ),
	/* State 12 */ new Array(  ),
	/* State 13 */ new Array(  ),
	/* State 14 */ new Array( 42/* Value */,43 ),
	/* State 15 */ new Array(  ),
	/* State 16 */ new Array(  ),
	/* State 17 */ new Array(  ),
	/* State 18 */ new Array( 37/* Expression */,44 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 19 */ new Array(  ),
	/* State 20 */ new Array(  ),
	/* State 21 */ new Array(  ),
	/* State 22 */ new Array(  ),
	/* State 23 */ new Array(  ),
	/* State 24 */ new Array( 34/* Stmt */,49 , 37/* Expression */,8 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 25 */ new Array(  ),
	/* State 26 */ new Array( 34/* Stmt */,50 , 37/* Expression */,8 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 27 */ new Array(  ),
	/* State 28 */ new Array(  ),
	/* State 29 */ new Array( 36/* Param_List */,53 , 37/* Expression */,54 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 30 */ new Array( 37/* Expression */,55 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 31 */ new Array( 39/* AddSubExp */,56 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 32 */ new Array( 39/* AddSubExp */,57 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 33 */ new Array( 39/* AddSubExp */,58 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 34 */ new Array( 39/* AddSubExp */,59 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 35 */ new Array( 39/* AddSubExp */,60 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 36 */ new Array( 39/* AddSubExp */,61 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 37 */ new Array(  ),
	/* State 38 */ new Array( 34/* Stmt */,62 , 37/* Expression */,8 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 39 */ new Array( 40/* MulDivExp */,64 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 40 */ new Array( 40/* MulDivExp */,65 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 41 */ new Array( 41/* NegExp */,66 , 42/* Value */,15 ),
	/* State 42 */ new Array( 41/* NegExp */,67 , 42/* Value */,15 ),
	/* State 43 */ new Array(  ),
	/* State 44 */ new Array(  ),
	/* State 45 */ new Array( 36/* Param_List */,69 , 37/* Expression */,54 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 46 */ new Array( 38/* Param_Def_List */,70 ),
	/* State 47 */ new Array(  ),
	/* State 48 */ new Array(  ),
	/* State 49 */ new Array(  ),
	/* State 50 */ new Array(  ),
	/* State 51 */ new Array( 37/* Expression */,75 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 52 */ new Array(  ),
	/* State 53 */ new Array(  ),
	/* State 54 */ new Array(  ),
	/* State 55 */ new Array(  ),
	...
	/* State 72 */ new Array(  ),
	/* State 73 */ new Array(  ),
	/* State 74 */ new Array( 34/* Stmt */,84 , 37/* Expression */,8 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 75 */ new Array(  ),
	/* State 76 */ new Array( 37/* Expression */,86 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 77 */ new Array(  ),
	/* State 78 */ new Array(  ),
	/* State 79 */ new Array(  ),
	/* State 80 */ new Array(  ),
	...
	/* State 86 */ new Array(  ),
	/* State 87 */ new Array(  ),
	/* State 88 */ new Array( 35/* Stmt_List */,89 ),
	/* State 89 */ new Array( 34/* Stmt */,62 , 37/* Expression */,8 , 39/* AddSubExp */,11 , 40/* MulDivExp */,12 , 41/* NegExp */,13 , 42/* Value */,15 ),
	/* State 90 */ new Array(  )
);
